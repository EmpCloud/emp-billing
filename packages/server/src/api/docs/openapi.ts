    ...
    schemas: {
      ...
      Organization: {
        ...
        properties: {
          ...
          fiscalYearStart: { type: "integer" as const },
      ...
      Client: {
        ...
        properties: {
          ...
          totalBilled: { type: "integer" as const, description: "Amount in smallest currency unit" },
      ...
      Invoice: {
        ...
        properties: {
          ...
          subtotal: { type: "integer" as const, description: "Amount in smallest currency unit" },
          ...
          amountDue: { type: "integer" as const },
      ...
      InvoiceItem: {
        ...
        properties: {
          ...
          taxAmount: { type: "integer" as const },
          taxComponents: { type: "object" as const },
      ...
      Quote: {
        ...
        properties: {
          ...
          orgId: { type: "string" as const, format: "uuid" },
          clientId: { type: "string" as const, format: "uuid" },
          quoteNumber: { type: "string" as const },
          status: {
            type: "string" as const,
      ...
      CreditNote: {
        ...
        properties: {
          ...
          orgId: { type: "string" as const, format: "uuid" },
          clientId: { type: "string" as const, format: "uuid" },
          creditNoteNumber: { type: "string" as const },
      ...
      DunningConfig: {
        ...
        properties: {
          ...
          retryIntervalDays: { type: "array" as const, items: { type: "integer" as const } },
      ...
      MRR: {
        type: "object" as const,
        properties: {
          mrr: { type: "integer" as const },
          growth: { type: "number" as const },
