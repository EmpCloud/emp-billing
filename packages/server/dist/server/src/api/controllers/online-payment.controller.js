...
async function listGateways(_req, res) {
...
async function createOrder(req, res) {
    ...
    const result = await onlinePaymentService.createPaymentOrder(orgId, invoiceId, gateway);
...
//# sourceMappingURL=online-payment.controller.js.map