 ...
 */
export const US_STATE_TAX_RATES: Record<string, StateTaxEntry> = {
 ...
 */
export const NO_SALES_TAX_STATES = ["AK", "DE", "MT", "NH", "OR"] as const;
...
export function getStateTaxRate(stateCode: string): number {
  ...
  const entry = US_STATE_TAX_RATES[upper];
