...
import { useCreateRecurringProfile } from "@/api/hooks/recurring.hooks";
...
export function RecurringCreatePage() {
  ...
  function onSubmit(values: FormValues) {
    ...
    createProfile.mutate(payload as unknown as Record<string, unknown>);
  }
  ...
  return (
    <div className="p-6 max-w-4xl">
      <PageHeader
        ...
        breadcrumb={[{ label: "Recurring Profiles", href: "/recurring" }, { label: "New Profile" }]}
      />
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          <Button type="submit" loading={isSubmitting || createProfile.isPending}>
            Create Profile
          </Button>
